      ...
      <div className="grid auto-rows-min gap-4 md:grid-cols-3">
        ...
        <div className="bg-muted/50 aspect-video rounded-xl p-4">
          ...
          <div className="mt-2">
            ...
            <p className="text-muted-foreground text-xs">前日比 +2件</p>
          </div>
        </div>
        <div className="bg-muted/50 aspect-video rounded-xl p-4">
          <div className="flex items-center gap-2">
          ...
          <div className="mt-2">
            ...
            <p className="text-muted-foreground text-xs">在庫あり商品</p>
          </div>
        </div>
      </div>
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-muted-foreground text-sm">3件</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-xs">今月新規: 12名</p>
              </div>
            </CardContent>
          </Card>
